...
CAPTIONS = [
    ...
    "We eat first, then we eat again",

    # Options Trading (21-40)
    "Options trading so sweet",
    "Calls printing like crazy",
    ...
    "Expiry day smiling at us",
    "Weeklies printing again",
    "We don't guess options, we read them",
    "Greeks working in our favour today",
    "The flow told us first",
    "Dark pool activity? We saw it coming",
    "Smart money followed us this time",
    "Options flow equals free money signals",
    "Monthlies looking lovely",
    ...
    "Built different in here",
    "Only winners allowed in this room",
    "This community prints",
    ...
    "Loyalty plus discipline equals this group",
    "We move as one",
    ...
    "Signal accuracy speaking for itself",
    ...
    "Patience plus signal equals profit",
    ...
    "The chart pattern played out exactly",
    ...
    "One good trade can change your week",
    ...
    "Sunday prep equals Monday profit",
